System.config({
  ...
  map: {
    ...
    "npm:aurelia-bootstrapper@1.0.0-beta.1.0.2": {
      ...
      "aurelia-logging-console": "npm:aurelia-logging-console@1.0.0-beta.1.1.1",
      "aurelia-pal": "npm:aurelia-pal@1.0.0-beta.1.1.0",
      "aurelia-pal-browser": "npm:aurelia-pal-browser@1.0.0-beta.1.1.1",
    ...
    "npm:aurelia-dependency-injection@1.0.0-beta.1.1.0": {
    ...
    "npm:aurelia-framework@1.0.0-beta.1.0.8": {
      ...
      "aurelia-dependency-injection": "npm:aurelia-dependency-injection@1.0.0-beta.1.1.0",
    ...
    "npm:aurelia-logging-console@1.0.0-beta.1.1.1": {
      "aurelia-logging": "npm:aurelia-logging@1.0.0-beta.1.1.0",
      "aurelia-pal": "npm:aurelia-pal@1.0.0-beta.1.1.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "path": "github:jspm/nodelibs-path@0.1.0",
    ...
    "npm:aurelia-pal-browser@1.0.0-beta.1.1.1": {
      "aurelia-pal": "npm:aurelia-pal@1.0.0-beta.1.1.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "core-js": "npm:core-js@2.0.3",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
